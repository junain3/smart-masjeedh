-- SIMPLE RLS POLICIES - Clean Multi-Tenant Architecture
-- No recursive policies, simple direct comparisons
...
DROP POLICY IF EXISTS "Users can delete families of their masjid" ON families;
...
DROP POLICY IF EXISTS "Users can update members of their masjid" ON members;
...
-- Step 3: Simple user_roles policies
...
-- Step 6: Simple families policies (if needed)
...
-- Step 7: Simple members policies (if needed)

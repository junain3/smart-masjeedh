          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            {onGiveAdvance && (
              <button
                ...
                className="inline-flex items-center justify-center rounded-2xl bg-amber-600 px-5 py-3 text-sm font-bold text-white transition hover:bg-amber-700"
              >
                Give Advance
              </button>
            )}
        ...
        {isEmployee && (
          <>
            ...
            <div className="rounded-2xl bg-rose-50 p-4 border border-rose-200">
              <div className="mb-2 flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-rose-600">
                <Wallet className="h-4 w-4" />
                Pending Arrears
              </div>
              <p className="text-sm font-bold text-rose-700">{formatCurrency(pendingArrears)}</p>
            </div>
            ...
            {(advancesPaid || 0) > 0 && (
              <div className="rounded-2xl bg-amber-50 p-4 border border-amber-200">
                ...
                <p className="text-sm font-bold text-amber-700">{formatCurrency(advancesPaid)}</p>
              </div>
            )}
          </>
        )}
